...
.slider::-moz-range-thumb {
  ...
  -webkit-border-radius: 7px;
   ...
   <b  class="button-blue" style="width:68%"><span id="datetime"></span></b>
  <button onclick="document.getElementById('id01').style.display='block'" class="button-blue" style="width:30%">Connect to Wi-Fi</button>
...
<form action="/myMesg" method="POST">
  <div class="data-input">
<div class="slidecontainer"><input type="text" placeholder="Enter your message here..."  name="Message" maxlength="655" class="button-white" style="width:78%;height:35px;font-size:30px">
  <input type="submit" value="Send" style="width:20%" class="button-blue">
  </div></div>
</form>
  </tr>
   <tr>
...
<div class="slidecontainer">
  <input type="range" name="Speed0" min="0" max="20" value="15" class="slider" style="width:60%" id="mySpeed0">
...
slider0.oninput = function() {
  ...
  <div class="data-input">
    <table>
  <form action="/mytimezon" method="GET">
   <td style="width:6%"><input type="number" value="0" name="locatz" min="-12" max="+12" class="button-blue">
  </td>
   <td style="width:22%"><input type="submit" value="Time Zone" class="button-blue">
  </form></td>
  <form action="/" method="GET">
   <td style="width:22%"><button onclick="myFunction()" class="button-blue">Set local Time</button>
  </form></td>
  <form action="/NTPtime" method="GET">
   <td style="width:22%"><input type="submit" value="Update Time (NTP)" class="button-blue">
  </form></td>
  <form action="/savetime" method="GET">
   <td style="width:22%"><input type="submit" value="Save Time RTC" class="button-blue">
  </form></td></table>
  </div>
  </tr>
   <tr>
  ...
  <b  class="button-blue" style="width:20%"><span id="TZmesg"></span></b>
  ...
  <input type="submit" value="Update Time" class="button-blue" style="width:34%">
  </form>
  </div>
  </tr>
   <tr><div class="data-input">
